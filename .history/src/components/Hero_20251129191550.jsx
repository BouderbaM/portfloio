      ...
      <div className="max-w-6xl mx-auto">
        <div className="grid grid-cols-1 md:grid-cols-2 gap-12 items-center">
          ...
          <div className="flex justify-center">
            <div className="w-64 h-64 sm:w-72 sm:h-72 bg-gradient-to-br from-cyan-500 to-blue-600 rounded-lg flex items-center justify-center shadow-lg hover:shadow-2xl transition">
              <div className="text-center">
                <User size={80} className="text-white mx-auto mb-4" />
                <p className="text-white font-semibold">Professional Headshot</p>
                <p className="text-gray-200 text-sm">Upload your photo here</p>
              </div>
            </div>
          </div>
        </div>

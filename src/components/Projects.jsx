...
export default function Projects() {
  ...
  const projects = [
    ...
    },
    {
      ...
      description: 'Developed a secure, user-friendly invoicing and billing application (Logiciel de facturation) tailored for small and medium businesses. The system supports invoice generation, client management, tax calculation, payment tracking, customizable templates, PDF export, and payment gateway integration. It automates billing workflows, reduces manual errors, and improves accounting efficiency for finance teams.',
